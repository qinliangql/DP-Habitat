...
class HumanoidRearrangeController(HumanoidBaseController):
    ...
    def calculate_walk_pose_vxy(
        ...
        self.vx = vx
        self.vy = vy
        forward_V = mn.Vector3(vx,0,vy)/self.motion_fps # 在这一步需要走的距离
        if (
        ...
        if self.prev_orientation is not None:
            ...
            prev_orientation = self.prev_orientation.normalized()
            prev_angle = (
        ...
        self.prev_orientation = copy.deepcopy(forward_V)
        ...
        step_size = max(
            1, int(distance_to_walk / self.dist_per_step_size)
        )
        ...
        # print("forward_V_dist:",forward_V_dist)
        # print("obj_transform_base.translation:",obj_transform_base.translation)
