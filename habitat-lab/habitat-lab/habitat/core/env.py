...
class Env:
    ...
    def reset(self) -> Observations:
        ...
        self.instance_id_to_label_id = {-1:-1}
        self.label_id_to_semantic = {-1:'human'}
        for obj in scene.objects:
            self.instance_id_to_label_id[int(obj.id.split("_")[-1])] = obj.category.index()
            self.label_id_to_semantic[obj.category.index()] = obj.id.split("_")[0]
